...
class Village:
    def __init__(self, config, level,build):
        self.level = level
...
def createVillage(level,building_levels):
    village = Village(getConfig(level), level,building_levels)
    return village
