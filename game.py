...
from characters import spawnBarbarian, move_barbarians, spawnArcher, spawnStealthArcher,move_archers,move_stealtharchers, spawnDragon, move_dragons, spawnBalloon, move_balloons, clearTroops, move_healers, spawnHealer,spawn_king
...
level = 1
building_levels={'cannon':1,'wizTower':1,'wall':3}

V = village.createVillage(level,building_levels)
...
while(True):
    ...
    if ch == 'w':
        ...
        spawnHealer(V.spawn_points[0],King)
    elif ch == '7':
        spawnHealer(V.spawn_points[1],King)
    elif ch == '8':
        spawnHealer(V.spawn_points[2],King)
    elif ch == 'q':
        print('quit')
        break
    # os.system('clear')
